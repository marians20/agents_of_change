...
const defaultText = `<div class="default-text">
                        <h1>Stock Market Chat</h1>
                        <p>I'm your AI-powered Stock Market Analyst with access to real-time data.<br />Ask me about stocks, trends, or company analysis!</p>
                    </div>`;
...
const streamChatResponse = async (incomingChatDiv) => {
    ...
    try {
        //const response = await fetch(`/chat?input=${userText}`, {
        const response = await fetch(`/streaming_chat?input=${userText}`, {
